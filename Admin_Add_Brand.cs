...
{
    public partial class Admin_Add_Brand : Form
    {
        public Admin_Add_Brand()
        {
            InitializeComponent();
        }

        private void Admin_Add_Brand_Load(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("Admin_Add_Brand_Load() called...");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "insert into Brands (name,country_of_origin) values('" + textBox2.Text + "','" + textBox3.Text + "')";

...
{
    public partial class Admin_Add_Order_Items : Form
    {
        public Admin_Add_Order_Items()
        {
            InitializeComponent();
        }

        private void Admin_Add_Order_Items_Load(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("Admin_Add_Order_Items_Load() called...");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "insert into Order_Items (order_id,perfume_id,quantity) values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "')";

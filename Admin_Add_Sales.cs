...
{
    public partial class Admin_Add_Sales : Form
    {
        public Admin_Add_Sales()
        {
            InitializeComponent();
        }

        private void Admin_Add_Sales_Load(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("Admin_Add_Sales_Load() called...");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "insert into Sales (customer_id,sale_date,total_amount) values('" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')";
